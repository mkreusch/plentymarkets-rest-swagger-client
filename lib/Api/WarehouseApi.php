...
class WarehouseApi
{
     ...
     * @return \OpenAPI\Client\Model\WarehouseLocationDimension
     */
    public function restWarehousesLayoutsPost($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key)
    {
        list($response) = $this->restWarehousesLayoutsPostWithHttpInfo($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WarehouseLocationDimension, HTTP status code, HTTP response headers (array of strings)
     */
    public function restWarehousesLayoutsPostWithHttpInfo($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key)
    {
        $request = $this->restWarehousesLayoutsPostRequest($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WarehouseLocationDimension' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WarehouseLocationDimension', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\WarehouseLocationDimension';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WarehouseLocationDimension',
     ...
     */
    public function restWarehousesLayoutsPostAsync($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key)
    {
        return $this->restWarehousesLayoutsPostAsyncWithHttpInfo($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restWarehousesLayoutsPostAsyncWithHttpInfo($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key)
    {
        $returnType = '\OpenAPI\Client\Model\WarehouseLocationDimension';
        $request = $this->restWarehousesLayoutsPostRequest($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key);
     ...
     */
    protected function restWarehousesLayoutsPostRequest($parent_id, $warehouse_id, $level, $name, $shortcut, $separator, $is_active_for_pickup_path, $dimension_id, $position, $level_id, $label, $purpose_key, $status_key)
    {
        ...
        if (is_array($shortcut)) {
            $shortcut = ObjectSerializer::serializeCollection($shortcut, '', true);
        }
        if ($shortcut !== null) {
        ...
        if (is_array($separator)) {
            $separator = ObjectSerializer::serializeCollection($separator, '', true);
        }
        if ($separator !== null) {
            $queryParams['separator'] = $separator;
        }
        // query params
        if (is_array($is_active_for_pickup_path)) {
            $is_active_for_pickup_path = ObjectSerializer::serializeCollection($is_active_for_pickup_path, '', true);
        }
        if ($is_active_for_pickup_path !== null) {
            $queryParams['isActiveForPickupPath'] = $is_active_for_pickup_path;
        }
        // query params
        if (is_array($dimension_id)) {
            $dimension_id = ObjectSerializer::serializeCollection($dimension_id, '', true);
        }
        if ($dimension_id !== null) {
            $queryParams['dimensionId'] = $dimension_id;
        }
        // query params
        ...
        if (is_array($level_id)) {
            $level_id = ObjectSerializer::serializeCollection($level_id, '', true);
        }
        if ($level_id !== null) {
            $queryParams['levelId'] = $level_id;
        }
        // query params
        if (is_array($label)) {
            $label = ObjectSerializer::serializeCollection($label, '', true);
        }
        if ($label !== null) {
            $queryParams['label'] = $label;
        }
        // query params
        if (is_array($purpose_key)) {
            $purpose_key = ObjectSerializer::serializeCollection($purpose_key, '', true);
        }
        if ($purpose_key !== null) {
            $queryParams['purposeKey'] = $purpose_key;
        }
        // query params
        if (is_array($status_key)) {
            $status_key = ObjectSerializer::serializeCollection($status_key, '', true);
        }
        if ($status_key !== null) {
            $queryParams['statusKey'] = $status_key;
        }
    ...
    protected function restWarehousesLocationsDeleteRequest($warehouse_location_ids)
    {
        ...
        if (is_array($warehouse_location_ids)) {
            $warehouse_location_ids = ObjectSerializer::serializeCollection($warehouse_location_ids, '', true);
        }
        if ($warehouse_location_ids !== null) {
            $queryParams['warehouseLocationIds'] = $warehouse_location_ids;
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WarehouseLocation[]
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WarehouseLocation[], HTTP status code, HTTP response headers (array of strings)
     */
    public function restWarehousesLocationsGroupPutWithHttpInfo($purpose, $status)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WarehouseLocation[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WarehouseLocation[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\WarehouseLocation[]';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WarehouseLocation[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function restWarehousesLocationsGroupPutRequest($purpose, $status)
    {
        ...
        // query params
        if (is_array($purpose)) {
            $purpose = ObjectSerializer::serializeCollection($purpose, '', true);
        }
        if ($purpose !== null) {
    ...
    protected function restWarehousesLocationsLevelsPositionsPostRequest($to_move, $target, $side)
    {
        ...
        // query params
        if (is_array($to_move)) {
            $to_move = ObjectSerializer::serializeCollection($to_move, '', true);
        }
        if ($to_move !== null) {
            $queryParams['toMove'] = $to_move;
        }
        // query params
        if (is_array($target)) {
        ...
        // query params
        if (is_array($side)) {
            $side = ObjectSerializer::serializeCollection($side, '', true);
        }
        if ($side !== null) {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WarehouseLocationLevel
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WarehouseLocationLevel, HTTP status code, HTTP response headers (array of strings)
     */
    public function restWarehousesLocationsLevelsPostWithHttpInfo($parent_id, $dimension_id, $position, $name)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WarehouseLocationLevel' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WarehouseLocationLevel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\WarehouseLocationLevel';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WarehouseLocationLevel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function restWarehousesLocationsMultipleDimensionsPostRequest($dimensions)
    {
        ...
        if (is_array($dimensions)) {
            $dimensions = ObjectSerializer::serializeCollection($dimensions, '', true);
        }
        if ($dimensions !== null) {
    ...
    protected function restWarehousesLocationsPreviewsPostRequest($dimensions, $storage_location_data, $level_data, $save)
    {
        ...
        // query params
        if (is_array($storage_location_data)) {
            $storage_location_data = ObjectSerializer::serializeCollection($storage_location_data, '', true);
        }
        if ($storage_location_data !== null) {
            $queryParams['storageLocationData'] = $storage_location_data;
        }
        // query params
        if (is_array($level_data)) {
            $level_data = ObjectSerializer::serializeCollection($level_data, '', true);
        }
        if ($level_data !== null) {
            $queryParams['levelData'] = $level_data;
        }
        // query params
        if (is_array($save)) {
            $save = ObjectSerializer::serializeCollection($save, '', true);
        }
        if ($save !== null) {
            $queryParams['save'] = $save;
        }
    ...
    protected function restWarehousesLocationsStockWarehouseLocationIdGetRequest($warehouse_location_id, $warehouse_location_id2)
    {
        ...
        // query params
        if (is_array($warehouse_location_id)) {
            $warehouse_location_id = ObjectSerializer::serializeCollection($warehouse_location_id, '', true);
        }
        if ($warehouse_location_id !== null) {
            $queryParams['$warehouseLocationId'] = $warehouse_location_id;
        }
     ...
     * @return object
     */
    public function restWarehousesLocationsWarehouseIdLabelPost($warehouse_id, $warehouse_location_ids)
    {
        list($response) = $this->restWarehousesLocationsWarehouseIdLabelPostWithHttpInfo($warehouse_id, $warehouse_location_ids);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function restWarehousesLocationsWarehouseIdLabelPostWithHttpInfo($warehouse_id, $warehouse_location_ids)
    {
        $request = $this->restWarehousesLocationsWarehouseIdLabelPostRequest($warehouse_id, $warehouse_location_ids);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restWarehousesLocationsWarehouseIdLabelPostAsync($warehouse_id, $warehouse_location_ids)
    {
        return $this->restWarehousesLocationsWarehouseIdLabelPostAsyncWithHttpInfo($warehouse_id, $warehouse_location_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restWarehousesLocationsWarehouseIdLabelPostAsyncWithHttpInfo($warehouse_id, $warehouse_location_ids)
    {
        $returnType = 'object';
        $request = $this->restWarehousesLocationsWarehouseIdLabelPostRequest($warehouse_id, $warehouse_location_ids);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function restWarehousesLocationsWarehouseIdLabelPostRequest($warehouse_id, $warehouse_location_ids)
    {
        // verify the required parameter 'warehouse_id' is set
        if ($warehouse_id === null || (is_array($warehouse_id) && count($warehouse_id) === 0)) {
            throw new \InvalidArgumentException(
