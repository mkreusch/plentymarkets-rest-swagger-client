...
class AccountingApi
{
     ...
     * @return \OpenAPI\Client\Model\PostingAccounts[]
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PostingAccounts[], HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsExistingAccountsGetWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PostingAccounts[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PostingAccounts[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\PostingAccounts[]';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PostingAccounts[]',
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RevenueAccountCountryConfiguration
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RevenueAccountCountryConfiguration, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdCountriesCountryIdRevenueAccountsGetWithHttpInfo($location_id, $country_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RevenueAccountCountryConfiguration' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RevenueAccountCountryConfiguration', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\RevenueAccountCountryConfiguration';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RevenueAccountCountryConfiguration',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\DebtorAccountConfiguration
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\DebtorAccountConfiguration, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdDebtorAccountConfigurationsGetWithHttpInfo($location_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\DebtorAccountConfiguration' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\DebtorAccountConfiguration', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\DebtorAccountConfiguration';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\DebtorAccountConfiguration',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AccountingLocation
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AccountingLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdGetWithHttpInfo($location_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\AccountingLocation' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\AccountingLocation', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\AccountingLocation';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\AccountingLocation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PostingKeyConfiguration
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PostingKeyConfiguration, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdPostingKeyConfigurationsGetWithHttpInfo($location_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PostingKeyConfiguration' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PostingKeyConfiguration', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\PostingKeyConfiguration';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PostingKeyConfiguration',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $location_id The ID of the accounting location (required)
     * @param  \OpenAPI\Client\Model\InlineObject2 $_rest_accounting_locations_location_id _rest_accounting_locations_location_id (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AccountingLocation
     */
    public function restAccountingLocationsLocationIdPut($location_id, $_rest_accounting_locations_location_id = null)
    {
        list($response) = $this->restAccountingLocationsLocationIdPutWithHttpInfo($location_id, $_rest_accounting_locations_location_id);
        return $response;
    }
     ...
     *
     * @param  int $location_id The ID of the accounting location (required)
     * @param  \OpenAPI\Client\Model\InlineObject2 $_rest_accounting_locations_location_id (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AccountingLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdPutWithHttpInfo($location_id, $_rest_accounting_locations_location_id = null)
    {
        $request = $this->restAccountingLocationsLocationIdPutRequest($location_id, $_rest_accounting_locations_location_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restAccountingLocationsLocationIdPutAsync($location_id, $_rest_accounting_locations_location_id = null)
    {
        return $this->restAccountingLocationsLocationIdPutAsyncWithHttpInfo($location_id, $_rest_accounting_locations_location_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restAccountingLocationsLocationIdPutAsyncWithHttpInfo($location_id, $_rest_accounting_locations_location_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\AccountingLocation';
        $request = $this->restAccountingLocationsLocationIdPutRequest($location_id, $_rest_accounting_locations_location_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function restAccountingLocationsLocationIdPutRequest($location_id, $_rest_accounting_locations_location_id = null)
    {
        // verify the required parameter 'location_id' is set
        if ($location_id === null || (is_array($location_id) && count($location_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($_rest_accounting_locations_location_id)) {
            $_tempBody = $_rest_accounting_locations_location_id;
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RevenueAccountLocationConfiguration
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RevenueAccountLocationConfiguration, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdRevenueAccountConfigurationsGetWithHttpInfo($location_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RevenueAccountLocationConfiguration' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RevenueAccountLocationConfiguration', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\RevenueAccountLocationConfiguration';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RevenueAccountLocationConfiguration',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AccountingLocationSettings
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AccountingLocationSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsLocationIdSettingsGetWithHttpInfo($location_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\AccountingLocationSettings' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\AccountingLocationSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\AccountingLocationSettings';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\AccountingLocationSettings',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Model\InlineObject1 $_rest_accounting_locations _rest_accounting_locations (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AccountingLocation
     */
    public function restAccountingLocationsPost($_rest_accounting_locations = null)
    {
        list($response) = $this->restAccountingLocationsPostWithHttpInfo($_rest_accounting_locations);
        return $response;
    }
     ...
     * Create an accounting location
     *
     * @param  \OpenAPI\Client\Model\InlineObject1 $_rest_accounting_locations (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AccountingLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function restAccountingLocationsPostWithHttpInfo($_rest_accounting_locations = null)
    {
        $request = $this->restAccountingLocationsPostRequest($_rest_accounting_locations);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restAccountingLocationsPostAsync($_rest_accounting_locations = null)
    {
        return $this->restAccountingLocationsPostAsyncWithHttpInfo($_rest_accounting_locations)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restAccountingLocationsPostAsyncWithHttpInfo($_rest_accounting_locations = null)
    {
        $returnType = '\OpenAPI\Client\Model\AccountingLocation';
        $request = $this->restAccountingLocationsPostRequest($_rest_accounting_locations);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function restAccountingLocationsPostRequest($_rest_accounting_locations = null)
    {
        ...
        if (isset($_rest_accounting_locations)) {
            $_tempBody = $_rest_accounting_locations;
        }
     ...
     *
     * @param  \OpenAPI\Client\Model\InlineObject249 $_rest_vat _rest_vat (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Vat
     */
    public function restVatPost($_rest_vat = null)
    {
        list($response) = $this->restVatPostWithHttpInfo($_rest_vat);
        return $response;
    }
     ...
     * Create a VAT configuration
     *
     * @param  \OpenAPI\Client\Model\InlineObject249 $_rest_vat (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Vat, HTTP status code, HTTP response headers (array of strings)
     */
    public function restVatPostWithHttpInfo($_rest_vat = null)
    {
        $request = $this->restVatPostRequest($_rest_vat);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restVatPostAsync($_rest_vat = null)
    {
        return $this->restVatPostAsyncWithHttpInfo($_rest_vat)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restVatPostAsyncWithHttpInfo($_rest_vat = null)
    {
        $returnType = '\OpenAPI\Client\Model\Vat';
        $request = $this->restVatPostRequest($_rest_vat);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function restVatPostRequest($_rest_vat = null)
    {
    ...
    protected function restVatStandardGetRequest($plenty_id = null, $started_at = null)
    {
        ...
        // query params
        if (is_array($started_at)) {
            $started_at = ObjectSerializer::serializeCollection($started_at, '', true);
        }
        if ($started_at !== null) {
            $queryParams['startedAt'] = $started_at;
        }
     ...
     *
     * @param  int $vat_id vat_id (required)
     * @param  \OpenAPI\Client\Model\InlineObject250 $_rest_vat_vat_id _rest_vat_vat_id (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Vat
     */
    public function restVatVatIdPut($vat_id, $_rest_vat_vat_id = null)
    {
        list($response) = $this->restVatVatIdPutWithHttpInfo($vat_id, $_rest_vat_vat_id);
        return $response;
    }
     ...
     *
     * @param  int $vat_id (required)
     * @param  \OpenAPI\Client\Model\InlineObject250 $_rest_vat_vat_id (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Vat, HTTP status code, HTTP response headers (array of strings)
     */
    public function restVatVatIdPutWithHttpInfo($vat_id, $_rest_vat_vat_id = null)
    {
        $request = $this->restVatVatIdPutRequest($vat_id, $_rest_vat_vat_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restVatVatIdPutAsync($vat_id, $_rest_vat_vat_id = null)
    {
        return $this->restVatVatIdPutAsyncWithHttpInfo($vat_id, $_rest_vat_vat_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restVatVatIdPutAsyncWithHttpInfo($vat_id, $_rest_vat_vat_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\Vat';
        $request = $this->restVatVatIdPutRequest($vat_id, $_rest_vat_vat_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function restVatVatIdPutRequest($vat_id, $_rest_vat_vat_id = null)
    {
        // verify the required parameter 'vat_id' is set
        if ($vat_id === null || (is_array($vat_id) && count($vat_id) === 0)) {
            throw new \InvalidArgumentException(
