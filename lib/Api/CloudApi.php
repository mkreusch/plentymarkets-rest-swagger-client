...
class CloudApi
{
    ...
    protected function restStorageFrontendFileMetadataPostRequest($key, $metadata)
    {
        ...
        if (is_array($metadata)) {
            $metadata = ObjectSerializer::serializeCollection($metadata, '', true);
        }
        if ($metadata !== null) {
    ...
    protected function restStorageFrontendFilePostRequest($key, $max_age = null)
    {
        ...
        // query params
        if (is_array($max_age)) {
            $max_age = ObjectSerializer::serializeCollection($max_age, '', true);
        }
        if ($max_age !== null) {
            $queryParams['maxAge'] = $max_age;
        }
    ...
    protected function restStoragePluginsInboxListGetRequest($prefix = null)
    {
        ...
        // query params
        if (is_array($prefix)) {
            $prefix = ObjectSerializer::serializeCollection($prefix, '', true);
        }
        if ($prefix !== null) {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CloudMetricsList
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CloudMetricsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function restSystemCloudMetricsGetWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CloudMetricsList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CloudMetricsList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CloudMetricsList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
